...
#VERSION='5.2.18' && \
apt install -y linux-headers-generic build-essential dkms  # && \
rm /tmp/finish


wget https://repo.zabbix.com/zabbix/4.4/ubuntu/pool/main/z/zabbix-release/zabbix-release_4.4-1+focal_all.deb -O zabbix-4.4.1.deb
